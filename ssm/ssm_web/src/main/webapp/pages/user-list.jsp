				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除选中" id="delete">
											<i class="fa fa-exclamation-triangle"></i> 删除选中
										</button>
									</div>
								</div>
							</div>
							...
							<!--数据列表-->
							<form action="${pageContext.request.contextPath}/user/deleteSelected.do" method="post" id="form">
							<table id="dataList"
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findOneById.do?id=${user.id}" class="btn bg-olive btn-xs">编辑</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}/user/findUserAndRoleById.do?id=${user.id}" class="btn bg-olive btn-xs">删除角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
